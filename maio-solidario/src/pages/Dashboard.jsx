  ...
  const updateCharts = (totaisPorCategoria, rankingArray, evolucaoArray, doacoes) => {
    ...
    if (chartComposicaoInstance.current) {
      ...
      const optionComposicao = {
        ...
        legend: {
          bottom: 0,
          textStyle: { color: '#c4b5a0', fontSize: 12 },
        },
        grid: {
          left: '100px',
          right: '40px',
        ...
        series: [
          {
            ...
            type: 'line',
            smooth: true,
            lineStyle: { width: 2, color: '#cca269' },
            itemStyle: { color: '#cca269' },
          ...
          },
          {
            ...
            type: 'line',
            smooth: true,
            lineStyle: { width: 2, color: '#91baa3' },
            itemStyle: { color: '#91baa3' },
            areaStyle: { color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
          ...
          },
          {
            ...
            type: 'line',
            smooth: true,
            lineStyle: { width: 2, color: '#a89e8b' },
            itemStyle: { color: '#a89e8b' },
            areaStyle: { color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
          ...
          },
          {
            ...
            type: 'line',
            smooth: true,
            lineStyle: { width: 2, color: '#66563d' },
            itemStyle: { color: '#66563d' },
            areaStyle: { color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
